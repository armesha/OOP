...
public interface Seznam<E> extends Iterable<E> {
    ...
    /**
     * Metoda nastavAktualni(int index) nastaví aktuální prvek na prvek
     * s indexem index.
     *
     * @param index index prvku, který se má nastavit jako aktuální
     *
     * @throws KolekceException tato výjimka se vystaví, když je index mimo
     * rozsah seznamu.
     */
    void nastavAktualni(int index) throws KolekceException;
